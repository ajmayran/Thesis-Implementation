# Generated by Django 5.2.5 on 2025-10-30 15:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['-created_at'], name='prediction__created_ea1178_idx'), models.Index(fields=['risk_level'], name='prediction__risk_le_46ea91_idx')],
            },
        ),
    ]
